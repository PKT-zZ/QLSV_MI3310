# Báo cáo bài tập lớn Kỹ thuật lập trình - Quản lý sinh viên

> Bản Markdown được chuyển từ PDF `KTLT(1).pdf`. Trang bìa đã được bỏ qua theo yêu cầu; nội dung bắt đầu từ mục lục.
...
## 7.1 Hàm main ... 46
## 7.2 Module quản lý sinh viên ... 48
## 7.3 Module quản lý môn học ... 53
## 7.4 Module quản lý lớp học phần ... 57
## 7.5 Module quản lý điểm số ... 62
## 7.6 Module đọc/ghi file ... 67
## 7.7 Module giao diện console ... 71
8 KẾT LUẬN 75
## 8.1 Kết quả đạt được ... 75
## 8.2 Hạn chế ... 77
## 8.3 Hướng phát triển ... 78
TÀI LIỆU THAM KHẢO 80
PHỤ LỤC 82
Phụ lục A. Code hàm main ... 82
Phụ lục B. Một số hàm xử lý chính ... 84
Phụ lục C. File dữ liệu mẫu ... 93
Phụ lục D. Một số kết quả kiểm thử ... 95
...
qua bài tập lớn, sinh viên không chỉ rèn luyện kỹ năng lập trình bằng ngôn ngữ C mà
...
Xuất phát từ yêu cầu đó, nhóm chúng em lựa chọn đề tài Quản lý sinh viên dựa
...
Xuất phát từ nhu cầu đó, nhóm chúng em thực hiện đề tài Quản lý sinh viên. Đây là
...
dữ liệu khi khởi động và ghi lại dữ liệu khi người dùng thoát. Bên cạnh đó, chương trình
...
## 1.2 Mục tiêu đề tài
Đề tài Quản lý sinh viên tập trung xây dựng một chương trình hỗ trợ quản lý các
...
thống có thể hiển thị bảng điểm của từng sinh viên, bảng điểm của lớp học phần, đồng
...
Trong quá trình thực hiện đề tài, nhóm phân chia công việc theo từng vai trò cụ thể
...
Dữ liệu đầu vào và đầu ra của chương trình phải được lưu trữ bằng file text. Người dùng
có thể nhập dữ liệu từ bàn phím, sau đó dữ liệu được xử lý trong chương trình và lưu lại
xuống các file tương ứng.
Một yêu cầu quan trọng của bài tập lớn là không sử dụng các cấu trúc dữ liệu nâng
cao hoặc thư viện thuật toán có sẵn. Các cấu trúc dữ liệu và thuật toán sử dụng trong
...
Chương trình Quản lý sinh viên cần cung cấp các chức năng cơ bản phục vụ việc quản
...
4 Quản lý điểm số Nhập và cập nhật điểm quá trình, điểm cuối
...
Bên cạnh các yêu cầu chức năng, chương trình Quản lý sinh viên cần đáp ứng một
...
trong các file text đúng định dạng, có thể
...
nhập điểm, tìm kiếm, sắp xếp, đọc/ghi file và
xử lý dữ liệu sai.
Nhìn chung, các yêu cầu phi chức năng trên giúp chương trình không chỉ đáp ứng
đúng chức năng quản lý sinh viên mà còn đảm bảo tính ổn định, rõ ràng và dễ kiểm tra.
Đây cũng là những yếu tố phù hợp với định hướng của môn Kỹ thuật lập trình, trong đó
...
Trong quá trình xây dựng chương trình Quản lý sinh viên, nhóm cần tuân thủ một
...
STT Ràng buộc Mô tả
1 Khóa chính Mã sinh viên, mã học phần và mã lớp học phần
không được trùng lặp trong danh sách tương ứng.
2 Điểm số Điểm quá trình và điểm cuối kỳ phải nằm trong
khoảng từ 0 đến 10.
3 Định dạng ngày sinh Ngày sinh của sinh viên được nhập theo định dạng
DD/MM/YYYY.
4 Quan hệ dữ liệu Mỗi lớp học phần phải gắn với một mã học phần
đã tồn tại trong danh sách môn học.
5 Bản ghi điểm Mỗi bản ghi điểm phải gắn với một sinh viên và
...
7 Ký tự phân cách Dữ liệu trong file text sử dụng ký tự | để phân
...
Dự án Quản lý sinh viên được tổ chức thành nhiều thư mục và file riêng biệt nhằm
...
theo từng nhiệm vụ cụ thể như xử lý dữ liệu, đọc/ghi file, tính điểm, tìm kiếm, sắp xếp,
...
.c, .h và Makefile. Thư mục data/ chứa các file dữ liệu dạng text dùng để lưu thông tin
sinh viên, môn học, lớp học phần và điểm số. Ngoài ra, các thư mục như screenshots/,
report/ và docs/ được sử dụng để lưu ảnh minh chứng, báo cáo và tài liệu phụ trợ.
...
Mô tả nhanh:
| |-- score.c
| |-- gpa.h • source/: chứa mã nguồn
| |-- gpa.c và các file kiểm thử.
| |-- search.h
• data/: chứa dữ liệu lưu trữ
| |-- search.c
dạng file text.
| |-- sort.h
• screenshots/: chứa ảnh
| |-- sort.c
minh chứng kết quả chạy
| |-- fileio.h
chương trình.
| |-- fileio.c
| |-- ui.h • report/: chứa báo cáo
| |-- ui.c cuối kỳ.
| |-- Makefile
...
điểm số, tính GPA, tìm kiếm, sắp xếp, đọc/ghi file và giao diện console. Ngoài ra, thư
...
dạng file text, mỗi dòng là một bản ghi và các trường được phân tách bằng ký tự |. Cách
...
trình.
data/ Chứa các file text dùng để lưu trữ dữ liệu sinh
...
công công việc và hướng dẫn build/chạy chương
trình.
Mô tả các nhóm file trong thư mục source/
Các file mã nguồn trong thư mục source/ được tổ chức theo từng nhóm chức năng
cụ thể:
• Nhóm file khởi động chương trình: gồm main.c. File này là điểm bắt đầu của
...
• Nhóm file định nghĩa dữ liệu: gồm types.h. File này định nghĩa các struct
chính như Student, Subject, CourseClass, ScoreRecord và các kiểu mảng động
tương ứng.
• Nhóm file cấu trúc dữ liệu: gồm arrays.h và arrays.c. Nhóm file này cài đặt
mảng động cho sinh viên, môn học, lớp học phần và điểm số.


<!-- Trang PDF 15 -->

• Nhóm file xử lý nghiệp vụ: gồm student.h/.c, subject.h/.c, courseclass.h/.c,
score.h/.c và gpa.h/.c. Các file này phụ trách thao tác thêm, sửa, xóa, tìm kiếm
bản ghi, xử lý điểm số và tính GPA.
• Nhóm file thuật toán: gồm search.h/.c và sort.h/.c. Nhóm file này cài đặt
chức năng tìm kiếm sinh viên và sắp xếp danh sách sinh viên.
• Nhóm file đọc/ghi dữ liệu: gồm fileio.h và fileio.c. Nhóm file này phụ trách
đọc dữ liệu từ các file trong thư mục data/ và ghi dữ liệu trở lại file text.
• Nhóm file giao diện: gồm ui.h và ui.c. Nhóm file này phụ trách hiển thị menu
console, nhận dữ liệu từ bàn phím, kiểm tra dữ liệu đầu vào và gọi các chức năng
xử lý tương ứng.
• Nhóm file kiểm thử: gồm test_arrays.c, test_fileio.c, test_fileio_unit.c,
test_gpa.c và test_types.c. Các file này được dùng để kiểm tra riêng từng module
quan trọng, từ đó giúp nhóm phát hiện lỗi sớm và đảm bảo chương trình hoạt động
ổn định hơn.
• File Makefile: hỗ trợ biên dịch chương trình nhanh chóng bằng lệnh make, giúp
...
đảm nhiệm một vai trò riêng. Cách tổ chức này giúp mã nguồn rõ ràng hơn, hạn chế việc
...
• Module main.c: là điểm bắt đầu của chương trình. File này thực hiện khởi tạo
các mảng dữ liệu, gọi hàm đọc dữ liệu từ file, hiển thị menu chính, lưu dữ liệu khi
người dùng thoát và giải phóng bộ nhớ đã cấp phát.
• Module types.h: phụ trách định nghĩa các kiểu dữ liệu chính của chương trình.
...
CourseClassArray và ScoreArray để sử dụng thống nhất trong toàn bộ chương
trình.
• Module arrays.h/.c: cài đặt cấu trúc dữ liệu mảng động cho từng nhóm dữ liệu.
...
tìm kiếm và giải phóng bộ nhớ. Khi mảng đầy, chương trình tự động mở rộng vùng
nhớ bằng cách tăng capacity.
• Module student.h/.c: phụ trách xử lý nghiệp vụ liên quan đến sinh viên. Module
...
dụng làm khóa chính để xác định từng sinh viên.
• Module subject.h/.c: phụ trách xử lý nghiệp vụ liên quan đến môn học. Module
...
• Module courseclass.h/.c: phụ trách xử lý nghiệp vụ liên quan đến lớp học phần.
Module này cung cấp các hàm thêm, cập nhật, xóa và tìm kiếm lớp học phần. Khi
thêm lớp học phần mới, chương trình kiểm tra mã lớp học phần MaLHP để tránh
trùng lặp, đồng thời kiểm tra mã học phần MaHP có tồn tại trong danh sách môn
học hay không.
• Module score.h/.c: phụ trách xử lý điểm số của sinh viên theo từng lớp học
...
• Module search.h/.c: phụ trách chức năng tìm kiếm sinh viên. Module này hỗ
...
• Module sort.h/.c: chứa các hàm sắp xếp danh sách sinh viên. Chương trình hỗ
...
• Module fileio.h/.c: phụ trách việc đọc và ghi dữ liệu từ các file text. Module
này cài đặt các hàm đọc/ghi riêng cho sinh viên, môn học, lớp học phần và điểm
số. Ngoài ra, hai hàm loadAllData và saveAllData được sử dụng để đọc hoặc ghi
...
• Module ui.h/.c: phụ trách giao diện console và xử lý tương tác với người dùng.
Module này hiển thị menu, nhận dữ liệu từ bàn phím, kiểm tra dữ liệu đầu vào, gọi
...
• Các file kiểm thử test_*.c: được sử dụng để kiểm tra tính đúng đắn của một số
...
hết xác định các nhiệm vụ chính của hệ thống, sau đó tinh chỉnh từng nhiệm vụ thành
...
tính bảo trì cao hơn. Các module như student.c, subject.c, courseclass.c và score.c
chỉ xử lý dữ liệu, trong khi ui.c chịu trách nhiệm nhập xuất và kiểm tra đầu vào. Khi
cần thay đổi giao diện hoặc bổ sung cách nhập dữ liệu mới, nhóm có thể sửa ở tầng giao
diện mà ít ảnh hưởng đến các hàm xử lý nghiệp vụ bên trong.
...
Sau khi dữ liệu đã được nạp, chương trình hiển thị menu chính để người dùng lựa
...
từ bộ nhớ xuống các file text để đảm bảo dữ liệu được lưu lại cho lần chạy sau.
...
đọc file, xử lý menu, lưu file và giải phóng bộ nhớ cũng giúp chương trình rõ ràng hơn
trong quá trình kiểm thử và bảo trì.
## 3.4 Thiết kế menu console
Chương trình sử dụng giao diện console với hệ thống menu phân cấp. Người dùng thao
...
Đối với các thao tác có liên quan đến nhiều nhóm dữ liệu, chương trình cũng kiểm
...
chương trình hạn chế dữ liệu sai và đảm bảo tính nhất quán giữa các file lưu trữ.
Nhìn chung, thiết kế menu console của chương trình được xây dựng theo hướng đơn
giản, rõ ràng và dễ thao tác. Các nhóm chức năng được phân chia hợp lý, phù hợp với yêu
cầu của đề tài Quản lý sinh viên. Đồng thời, cách thiết kế này cũng giúp quá trình kiểm
...
chương trình.
Các struct chính của chương trình được khai báo trong file types.h. Đây là file
...
mảng động như StudentArray, SubjectArray, CourseClassArray và ScoreArray. Mỗi
...
cần dùng mảng tĩnh có kích thước cố định mà vẫn có thể quản lý dữ liệu linh hoạt trong
quá trình chạy.
...
Trong chương trình Quản lý sinh viên, các dữ liệu không tồn tại độc lập mà có mối
...
• Sinh viên và điểm số: mỗi sinh viên có thể có nhiều bản ghi điểm khác nhau.
Trường MSSV trong ScoreRecord dùng để liên kết bản ghi điểm với sinh viên tương
ứng.
• Môn học và lớp học phần: mỗi môn học có thể được mở thành nhiều lớp học
phần. Trường MaHP trong CourseClass dùng để xác định lớp học phần đó thuộc
môn học nào.
• Lớp học phần và điểm số: mỗi lớp học phần có thể có nhiều sinh viên tham gia
và có nhiều bản ghi điểm. Trường MaLHP trong ScoreRecord dùng để liên kết điểm
số với lớp học phần tương ứng.
• Bản ghi điểm: một bản ghi điểm được xác định duy nhất bởi cặp MSSV và MaLHP.
Điều này đảm bảo một sinh viên chỉ có một bản ghi điểm trong cùng một lớp học
phần.
...
vì sử dụng cơ sở dữ liệu, nhóm lựa chọn cách lưu dữ liệu bằng file văn bản để phù hợp
...
tiên của mỗi file là dòng tiêu đề, dùng để mô tả tên các trường dữ liệu.
data/
...
File subjects.txt
File subjects.txt dùng để lưu thông tin môn học. Mỗi môn học gồm mã học phần,
tên học phần và số tín chỉ.
MaHP|TenHP|SoTinChi
MI3310|Ky Thuat Lap Trinh|2
MI3060|Cau Truc Du Lieu & Thuat Toan|3
Trường MaHP là khóa chính của môn học. Mỗi môn học có một mã học phần riêng và
...
File course_classes.txt dùng để lưu thông tin lớp học phần. Mỗi lớp học phần gồm
...
Nhìn chung, cách tổ chức dữ liệu bằng các file text giúp chương trình đơn giản, dễ
...
Trong chương trình Quản lý sinh viên, dữ liệu được lưu trữ bằng các file text trong
...
bộ nhớ. Khi người dùng chọn thoát chương trình, toàn bộ dữ liệu hiện tại sẽ được ghi lại
...
Tách trường bằng ký tự |
Định dạng dữ liệu theo file text
Kiểm tra và chuyển đổi dữ liệu
Ghi bản ghi xuống file
Thêm bản ghi vào mảng động
Đóng file
Đóng file
Ở luồng đọc file, chương trình mở lần lượt các file dữ liệu như students.txt, subjects.txt,
course_classes.txt và scores.txt. Sau khi bỏ qua dòng tiêu đề, chương trình đọc từng
dòng, tách các trường bằng ký tự |, kiểm tra dữ liệu và đưa bản ghi hợp lệ vào mảng
động tương ứng.
Ở luồng ghi file, khi người dùng chọn thoát chương trình, dữ liệu trong các mảng động
...
Cách tổ chức này giúp chương trình có thể lưu trữ dữ liệu giữa các lần chạy mà không
cần sử dụng cơ sở dữ liệu. Đồng thời, việc đọc dữ liệu vào bộ nhớ rồi xử lý trên mảng
...
# Chương 5. CẤU TRÚC DỮ LIỆU VÀ THUẬT
TOÁN
...
với các dữ liệu đó, chương trình cần có các thao tác như thêm, sửa, xóa, tìm kiếm, sắp
...
Trong chương trình Quản lý sinh viên, nhóm sử dụng cấu trúc dữ liệu mảng động tự
...
Tương tự, chương trình cũng xây dựng các mảng động khác như SubjectArray,
CourseClassArray và ScoreArray để lưu trữ môn học, lớp học phần và điểm số. Cách
thiết kế này giúp mỗi loại dữ liệu có một mảng riêng, dễ sử dụng và tránh nhầm lẫn kiểu
dữ liệu trong quá trình xử lý.
Cơ chế hoạt động của mảng động được mô tả qua sơ đồ luồng sau:
Khởi tạo mảng động
Cấp phát vùng nhớ ban đầu
Thêm phần tử mới
Có Mở rộng vùng nhớ
size == capacity?
tăng capacity
...
chưa. Nếu mảng đã đầy, chương trình sẽ cấp phát lại vùng nhớ với dung lượng lớn hơn,
...
ngữ C, đặc biệt là quá trình cấp phát, mở rộng và giải phóng vùng nhớ. Đồng thời, cấu
trúc dữ liệu này cũng đáp ứng yêu cầu của bài tập lớn là không sử dụng các thư viện cấu
trúc dữ liệu có sẵn, mà phải tự xây dựng cấu trúc dữ liệu và thuật toán cần thiết.
## 5.2 Tìm kiếm tuyến tính
Trong chương trình Quản lý sinh viên, thuật toán tìm kiếm tuyến tính được sử dụng
để tìm kiếm dữ liệu trong các danh sách như sinh viên, môn học, lớp học phần và điểm
số. Đây là thuật toán tìm kiếm cơ bản, phù hợp với dữ liệu được lưu trong mảng động và
...
liệu khác nhau. Ví dụ, tìm sinh viên theo MSSV, tìm môn học theo MaHP, tìm lớp học phần
...
Tương tự, các hàm tìm kiếm khác như suba_find, cca_find và sca_find cũng được
xây dựng theo cùng nguyên tắc. Điểm khác nhau chủ yếu nằm ở trường dữ liệu được dùng
làm khóa tìm kiếm.
Độ phức tạp thời gian của thuật toán tìm kiếm tuyến tính là O(n) trong trường hợp
xấu nhất, khi phần tử cần tìm nằm ở cuối danh sách hoặc không tồn tại trong danh sách.
...
nhưng thuật toán này đơn giản, dễ cài đặt và phù hợp với phạm vi của bài tập lớn. Ngoài
...
Trong chương trình Quản lý sinh viên, chức năng sắp xếp được sử dụng để sắp xếp
...
qua hàm strcmp. Đối với sắp xếp theo GPA, chương trình tính GPA hệ 10 của từng sinh
viên, sau đó sắp xếp theo thứ tự giảm dần để sinh viên có GPA cao hơn đứng trước.
Thuật toán được sử dụng là Bubble Sort. Đây là thuật toán đơn giản, dễ cài đặt và
phù hợp với quy mô dữ liệu nhỏ của bài tập lớn. Mặc dù Bubble Sort chưa tối ưu với dữ
liệu lớn do độ phức tạp trung bình và xấu là O(n2), thuật toán này giúp thể hiện rõ quá
...
hàm như sortStudentByMSSV và sortStudentByName. Khi người dùng chọn chức năng
...
Độ phức tạp thời gian của Bubble Sort là O(n2) trong trường hợp trung bình và xấu
nhất, với n là số lượng sinh viên trong danh sách. Độ phức tạp bộ nhớ là O(1) vì thuật
...
Trong chương trình Quản lý sinh viên, điểm số của sinh viên được quản lý theo từng
...
i=1 i
Trong đó:
• DiemTK : điểm tổng kết của học phần thứ i.
• SoTinChi : số tín chỉ của học phần thứ i.
...
SoTinChi
i=1 i
Trong chương trình, để tính GPA, cần liên kết dữ liệu giữa bản ghi điểm, lớp học phần
và môn học. Cụ thể, từ ScoreRecord lấy được MaLHP, từ CourseClass xác định MaHP,
...
Chương trình Quản lý sinh viên được xây dựng bằng ngôn ngữ lập trình C và chạy
...
cd source
make all
Trong trường hợp không sử dụng Makefile, có thể biên dịch thủ công bằng GCC bằng
...
Dựa trên yêu cầu của đề tài, chương trình Quản lý sinh viên đã cài đặt các nhóm chức
...
• Cập nhật điểm đã có.
• Tìm kiếm điểm theo mã số sinh viên, mã lớp học phần hoặc cặp mã số sinh viên và
mã lớp học phần.
Khi nhập điểm, chương trình kiểm tra sinh viên và lớp học phần có tồn tại hay không.
...
dữ liệu bằng file text. Khi chương trình khởi động, dữ liệu được đọc từ các file trong thư
...
Nhìn chung, các chức năng đã cài đặt đáp ứng được yêu cầu chính của đề tài Quản
lý sinh viên. Chương trình cho phép quản lý dữ liệu cơ bản, xử lý điểm số, tìm kiếm, sắp
...
được lưu trong thư mục data/ dưới dạng file text, trong đó mỗi dòng biểu diễn một bản
ghi và các trường dữ liệu được phân tách bằng ký tự |.
...
students.txt Thông tin sinh viên gồm Kiểm tra chức năng quản
MSSV, họ tên, lớp và ngày lý sinh viên, tìm kiếm sinh
sinh viên và liên kết với bảng
điểm
subjects.txt Thông tin môn học gồm mã Kiểm tra chức năng quản lý
học phần, tên học phần và môn học và phục vụ tính
số tín chỉ GPA theo tín chỉ
course_classes.txt Thông tin lớp học phần gồm Kiểm tra quan hệ giữa lớp
mã lớp học phần, mã học học phần và môn học
phần, học kỳ và năm học
scores.txt Điểm của sinh viên theo lớp Kiểm tra chức năng nhập
học phần, gồm điểm quá điểm, cập nhật điểm, tính
trình, điểm cuối kỳ, điểm điểm tổng kết, tính GPA và
tổng kết và điểm hệ 4 in bảng điểm
...
Sinh viên 6 Kiểm tra hiển thị danh sách,
tìm kiếm, sắp xếp và liên kết
với điểm số
Môn học 5 Kiểm tra quản lý môn học
và số tín chỉ khi tính GPA
Lớp học phần 5 Kiểm tra quan hệ giữa môn
học và lớp học phần
Bản ghi điểm 22 Kiểm tra nhập điểm, cập
...
tại, file rỗng, dòng thiếu trường, khóa chính bị trùng, điểm nằm ngoài khoảng từ 0 đến
...
• Dữ liệu hợp lệ: dùng để kiểm tra các chức năng chính như hiển thị danh sách,
tìm kiếm, sắp xếp, nhập điểm và in bảng điểm.
• Dữ liệu trùng khóa: dùng để kiểm tra việc không cho phép thêm sinh viên, môn
học, lớp học phần hoặc bản ghi điểm bị trùng khóa.
• Dữ liệu sai định dạng: dùng để kiểm tra khả năng bỏ qua dòng thiếu trường
hoặc trường bắt buộc bị rỗng.
• Dữ liệu điểm không hợp lệ: dùng để kiểm tra việc từ chối điểm nhỏ hơn 0 hoặc
lớn hơn 10.
• Dữ liệu sai tham chiếu: dùng để kiểm tra các trường hợp mã sinh viên, mã học
phần hoặc mã lớp học phần không tồn tại.


<!-- Trang PDF 45 -->

• Dữ liệu biên: dùng để kiểm tra thao tác với mảng rỗng, chỉ số không hợp lệ và
file không tồn tại.
...
đọc/ghi file, tính điểm và tính GPA.
## 6.4 Bảng test case
...
học phần, quản lý điểm số, tìm kiếm, sắp xếp, tính GPA, đọc/ghi file và kiểm tra dữ liệu
không hợp lệ. Các test case được thực hiện thông qua giao diện console kết hợp với các
file kiểm thử riêng cho module nền tảng.
...
Mã Chức năng Dữ liệu / tình huống Kết quả mong đợi Kết
TC kiểm thử quả
TC02 Thêm sinh viên Nhập MSSV đã tồn tại Chương trình hiển thị Đạt
...
scores.txt
TC06 Thêm môn học Nhập môn học mới với Môn học được thêm Đạt
hợp lệ mã học phần chưa tồn thành công
tại
TC07 Thêm môn học Nhập mã học phần đã Chương trình báo lỗi và Đạt
...
dụng phần tham chiếu vẹn dữ liệu
...
Mã Chức năng Dữ liệu / tình huống Kết quả mong đợi Kết
TC kiểm thử quả
TC14 Nhập điểm cho Nhập MSSV không có Chương trình báo lỗi và Đạt
...
TC17 Tính điểm Điểm quá trình là 8.5, Điểm tổng kết bằng Đạt
...
tại
TC21 Sắp xếp sinh Danh sách sinh viên Danh sách được hiển thị Đạt
...
Mã Chức năng Dữ liệu / tình huống Kết quả mong đợi Kết
TC kiểm thử quả
TC25 Đọc file không Truyền đường dẫn file Chương trình không bị Đạt
...
liệu sai định dạng, dữ liệu sai tham chiếu và các thao tác cơ bản trên mảng động.
...
## 7.1 Hàm main
Hàm main là điểm bắt đầu của chương trình và đóng vai trò điều phối toàn bộ quá
trình hoạt động của hệ thống. Trong chương trình Quản lý sinh viên, hàm main không
trực tiếp xử lý các nghiệp vụ chi tiết như thêm sinh viên, nhập điểm hay tính GPA, mà
...
và danh sách điểm số. Các mảng này lần lượt có kiểu StudentArray, SubjectArray,
CourseClassArray và ScoreArray.
Sau khi khai báo, chương trình tiến hành khởi tạo từng mảng động bằng các hàm
...
Listing 7.1: Cài đặt hàm main của chương trình
...
Listing 7.2: Struct Student lưu thông tin sinh viên


<!-- Trang PDF 52 -->

Mỗi sinh viên gồm bốn thông tin chính: mã số sinh viên, họ tên, lớp hành chính và
...
viên này.
Danh sách sinh viên được lưu trữ bằng cấu trúc StudentArray. Đây là mảng động tự
...
Listing 7.3: Cấu trúc mảng động StudentArray
Các hàm nghiệp vụ cơ bản của module sinh viên được cài đặt trong file student.c và
khai báo trong file student.h. Các hàm này không trực tiếp nhập dữ liệu từ bàn phím
...
Hàm Chức năng
findStudentRecord Tìm sinh viên theo MSSV. Nếu tìm thấy,
...
updateStudentRecord Cập nhật thông tin sinh viên dựa trên MSSV.
...
Đoạn mã sau thể hiện các hàm xử lý nghiệp vụ chính của module quản lý sinh viên:
...
hoặc sa_remove.
Ở tầng giao diện, các chức năng quản lý sinh viên được tích hợp trong menu QUAN
...
**Bảng 7.2: Các chức năng sinh viên trong tầng giao diện**
Chức năng Mô tả
...
văn bản không được để trống và không được chứa ký tự |, vì đây là ký tự dùng để phân
...
Riêng thao tác xóa sinh viên, ràng buộc toàn vẹn dữ liệu được kiểm tra tại tầng giao
...
Nhìn chung, module quản lý sinh viên đã đáp ứng được các chức năng cần thiết của
...
Module quản lý môn học là module dùng để lưu trữ và xử lý thông tin các học phần
...
Listing 7.5: Struct Subject lưu thông tin môn học
Danh sách môn học được lưu bằng cấu trúc SubjectArray. Đây là mảng động định
kiểu riêng dành cho dữ liệu môn học, gồm con trỏ data, số phần tử hiện tại size và sức
...
Listing 7.6: Cấu trúc mảng động SubjectArray
...
**Bảng 7.3: Các hàm chính trong module quản lý môn học**
Hàm Chức năng
findSubjectRecord Tìm môn học theo mã học phần MaHP. Nếu
tìm thấy, hàm trả về con trỏ đến môn học
tương ứng; nếu không tìm thấy, hàm trả về
NULL.
addSubjectRecord Thêm môn học mới vào danh sách. Trước khi
thêm, hàm kiểm tra mã học phần đã tồn tại
hay chưa để tránh trùng khóa chính.
updateSubjectRecord Cập nhật thông tin môn học dựa trên mã học
phần. Nếu mã học phần không tồn tại, hàm
trả về thất bại.
deleteSubjectRecord Xóa môn học khỏi danh sách dựa trên mã
...
Ở tầng giao diện, module môn học được tích hợp trong menu QUAN LY MON HOC. Người
...
học phần hợp lệ, kiểm tra trùng mã học phần
và kiểm tra số tín chỉ hợp lệ.
Sửa môn học Tìm môn học theo mã học phần và cho phép
...
được dùng làm dấu phân tách khi lưu dữ liệu xuống file text. Số tín chỉ phải là số nguyên
...
CourseClass. Vì vậy, trước khi xóa môn học, tầng giao diện sẽ kiểm tra xem có lớp học


<!-- Trang PDF 60 -->

phần nào đang sử dụng mã học phần đó hay không. Nếu môn học đang được tham chiếu,
...
của hệ thống. Việc tách riêng phần xử lý nghiệp vụ trong subject.c và phần nhập xuất
...
Module quản lý lớp học phần dùng để quản lý các lớp học phần được mở trong từng
...
Listing 7.8: Struct CourseClass lưu thông tin lớp học phần
Trong đó, trường maLHP là khóa chính dùng để phân biệt các lớp học phần với nhau.
...
học phần thuộc môn học nào và sử dụng số tín chỉ của môn học khi tính GPA cho sinh viên.
Danh sách lớp học phần được lưu trữ bằng cấu trúc CourseClassArray. Đây là mảng
...
Listing 7.9: Cấu trúc mảng động CourseClassArray


<!-- Trang PDF 61 -->

Các thao tác nghiệp vụ chính của module lớp học phần được cài đặt trong file
...
Hàm Chức năng
findCourseClassRecord Tìm lớp học phần theo mã lớp học phần
MaLHP. Nếu tìm thấy, hàm trả về con trỏ đến
lớp học phần tương ứng; nếu không tìm thấy,
hàm trả về NULL.
addCourseClassRecord Thêm lớp học phần mới vào danh sách. Hàm
kiểm tra trùng mã lớp học phần và kiểm tra
mã học phần có tồn tại trong danh sách môn
học hay không.
updateCourseClassRecord Cập nhật thông tin lớp học phần dựa trên mã
lớp học phần. Nếu mã lớp học phần không
tồn tại, hàm trả về thất bại.
deleteCourseClassRecord Xóa lớp học phần khỏi danh sách dựa trên
mã lớp học phần. Nếu không tìm thấy lớp học
...
Trong các hàm trên, cca_find được sử dụng để tìm lớp học phần theo mã MaLHP. Khi
...
Ở tầng giao diện, module lớp học phần được tích hợp trong menu QUAN LY LOP HOC
...
**Bảng 7.6: Các chức năng lớp học phần trong tầng giao diện**
Chức năng Mô tả
...
phần không trùng, mã học phần tồn tại, học
...
tin. Nếu mã học phần mới không tồn tại trong danh sách môn học, chương trình sẽ giữ
...
Module quản lý điểm số dùng để lưu trữ và xử lý điểm của sinh viên theo từng lớp
học phần. Đây là module liên kết trực tiếp giữa sinh viên và lớp học phần, vì mỗi bản
ghi điểm đều chứa mã số sinh viên mssv và mã lớp học phần maLHP. Trong chương trình,
...
đổi sang hệ 4.
Danh sách điểm được lưu trữ bằng cấu trúc ScoreArray. Đây là mảng động định kiểu
...
Listing 7.12: Cấu trúc mảng động ScoreArray
Module điểm số có nhiệm vụ chính là thêm điểm, cập nhật điểm, tính điểm tổng kết
...
**Bảng 7.7: Các hàm chính trong module quản lý điểm số**
Hàm Chức năng
...
Listing 7.13: Hàm tính điểm tổng kết và quy đổi điểm hệ 4
Khi thêm một bản ghi điểm mới, chương trình cần đảm bảo dữ liệu có tính liên kết.
Cụ thể, sinh viên phải tồn tại trong danh sách sinh viên và lớp học phần phải tồn tại
...
Listing 7.14: Hàm thêm bản ghi điểm
...
if(idx == -1)
return 0;
scores ->data[idx].diemQT = diemQT;
scores ->data[idx].diemCK = diemCK;
...
Listing 7.15: Hàm cập nhật điểm
...
lớp học phần, điểm quá trình, điểm cuối kỳ,
...
có cùng MSSV, sau đó in ra điểm của từng lớp học phần. Đồng thời, dữ liệu điểm được
sử dụng để tính GPA hệ 10, GPA hệ 4 và học lực của sinh viên. Khi xem bảng điểm của


<!-- Trang PDF 70 -->

một lớp học phần, chương trình lọc các bản ghi điểm theo maLHP và hiển thị danh sách
...
Module đọc/ghi file có nhiệm vụ lưu trữ dữ liệu của chương trình xuống bộ nhớ ngoài
...
data/students.txt Lưu danh sách sinh viên, gồm MSSV, họ tên,
lớp và ngày sinh.
data/subjects.txt Lưu danh sách môn học, gồm mã học phần,
tên học phần và số tín chỉ.
data/course_classes.txt Lưu danh sách lớp học phần, gồm mã lớp học
phần, mã học phần, học kỳ và năm học.
data/scores.txt Lưu danh sách điểm, gồm MSSV, mã lớp học
...
dữ liệu thực tế.
**Bảng 7.10: Định dạng các file dữ liệu**
File Định dạng một dòng dữ liệu
...
Ví dụ, một số dòng dữ liệu có thể được lưu như sau:
202400000| Nguyen Van Toan|K69-MI1 -01|15/08/2006
MI3310|Ky thuat lap trinh|2
169313|MI3310|1|2025
202400000|169313|8.00|9.00|8.50|4.00
Listing 7.17: Ví dụ định dạng dữ liệu trong file text
Module đọc/ghi file cung cấp các hàm đọc và ghi riêng cho từng loại dữ liệu. Các hàm
đọc có nhiệm vụ mở file, đọc từng dòng, tách các trường dữ liệu, kiểm tra tính hợp lệ
...
**Bảng 7.11: Các hàm đọc/ghi dữ liệu chính**
Hàm Chức năng
...
loadSubjects Đọc danh sách môn học từ file subjects.txt
vào SubjectArray.
saveSubjects Ghi danh sách môn học từ SubjectArray
xuống file subjects.txt.
loadCourseClasses Đọc danh sách lớp học phần
...
file scores.txt.
loadAllData Đọc toàn bộ dữ liệu của chương trình theo
đúng thứ tự.
...
dòng có MSSV rỗng hoặc dòng bị trùng MSSV. Với file môn học, chương trình kiểm tra
...
Một điểm quan trọng của module đọc/ghi file là khi đọc dữ liệu điểm, chương trình
...
kỳ. Điều này giúp dữ liệu điểm nhất quán hơn, tránh trường hợp file bị sửa thủ công làm
sai điểm tổng kết hoặc điểm quy đổi.
Quy trình đọc toàn bộ dữ liệu được thực hiện bởi hàm loadAllData. Hàm này đọc dữ
...
đến một mã học phần có tồn tại trong danh sách môn học. Mỗi bản ghi điểm phải tham
chiếu đến một sinh viên có thật và một lớp học phần có thật. Những bản ghi tham chiếu
...
Listing 7.18: Ý tưởng xử lý của hàm loadAllData
...
Listing 7.19: Ý tưởng xử lý của hàm saveAllData
Module đọc/ghi file cũng được kiểm thử bằng cả unit test và integration test. Trong
unit test, chương trình tạo file tạm để kiểm tra riêng hàm loadStudents và saveStudents,
...
bộ quy trình loadAllData và saveAllData với dữ liệu thật trong thư mục data/. Kết
...
dài thay vì chỉ xử lý tạm thời trong bộ nhớ RAM. Việc chia dữ liệu thành bốn file riêng
giúp cấu trúc lưu trữ rõ ràng, dễ kiểm tra và dễ bảo trì. Đồng thời, các bước kiểm tra dữ
...
dùng. Module này hiển thị các menu chức năng, nhận dữ liệu nhập từ bàn phím, kiểm tra
tính hợp lệ của dữ liệu và gọi các hàm xử lý tương ứng của những module khác. Trong
chương trình, phần giao diện được cài đặt trong file ui.c và được khai báo public thông
qua file ui.h.
...
thiết kế này giúp che giấu chi tiết cài đặt bên trong module, đồng thời làm cho các module
khác chỉ cần gọi menu chính mà không cần biết toàn bộ cấu trúc menu con.
void showMainMenu(StudentArray* students ,
SubjectArray* subjects ,
CourseClassArray* classes ,
ScoreArray* scores);
Listing 7.20: Hàm giao diện chính được khai báo trong ui.h
Hàm showMainMenu nhận vào bốn mảng động chính của chương trình, bao gồm danh
...
chính sẽ lưu dữ liệu xuống file.
...
liệu đầu vào. Chương trình sử dụng các hàm tiện ích như readLine, readLineOptional,
...
**Bảng 7.13: Một số hàm tiện ích nhập dữ liệu trong ui.c**
Hàm Chức năng
readLine Nhập chuỗi bắt buộc, không cho phép bỏ
trống và không cho phép chứa ký tự |.
readLineOptional Nhập chuỗi tùy chọn, dùng trong các chức
năng sửa thông tin. Nếu người dùng bỏ trống
thì giữ nguyên dữ liệu cũ.
readInt Nhập số nguyên và kiểm tra đúng định dạng
số nguyên.
...
**Bảng 7.14: Các kiểm tra dữ liệu đầu vào trong module giao diện**
...
Ngày sinh Đúng định dạng DD/MM/YYYY, ngày tháng
năm phải hợp lệ.
...
hạn cho phép.
Điểm số Điểm quá trình và điểm cuối kỳ phải nằm
...
điểm hay chưa; nếu đã có điểm thì không cho phép xóa nhằm tránh dữ liệu điểm bị mồ côi.
...
lớp học phần tồn tại và cặp MSSV + MaLHP chưa bị trùng. Điểm quá trình và điểm cuối
...
trình Quản lý sinh viên chạy trên giao diện console bằng ngôn ngữ lập trình C. Chương
...
Trước hết, nhóm đã thiết kế được hệ thống dữ liệu tương đối rõ ràng thông qua các
...
đó, chương trình có thể thêm, sửa, xóa, tìm kiếm và quản lý dữ liệu linh hoạt hơn so với
...
dễ bảo trì hơn. Khi thêm dữ liệu mới, chương trình có kiểm tra khóa chính để hạn chế
...
Tìm kiếm Đọc/ghi Kiểm thử
và sắp xếp file text module
Bên cạnh việc cài đặt chức năng, nhóm cũng đã xây dựng một số file kiểm thử cho các
module quan trọng như mảng động, đọc/ghi file, tính GPA và định nghĩa kiểu dữ liệu.
Các file kiểm thử này giúp kiểm tra các trường hợp cơ bản, trường hợp biên, dữ liệu sai
...
theo module, sử dụng struct, quản lý bộ nhớ động, đọc/ghi file, tìm kiếm, sắp xếp, kiểm
tra dữ liệu đầu vào và kiểm thử chương trình.
## 8.2 Hạn chế
Mặc dù chương trình Quản lý sinh viên đã đáp ứng được các yêu cầu cơ bản của đề
...
Trước hết, giao diện của chương trình mới dừng lại ở dạng console. Người dùng thao
...
Thứ hai, dữ liệu của chương trình được lưu trữ bằng file text. Cách lưu trữ này dễ
...
Thứ ba, các thuật toán tìm kiếm và sắp xếp trong chương trình còn ở mức cơ bản.
...
khi số lượng bản ghi lớn. Ví dụ, Bubble Sort có độ phức tạp thời gian O(n2) nên tốc độ
...
Thứ năm, việc kiểm tra dữ liệu đầu vào tuy đã được thực hiện ở nhiều vị trí nhưng vẫn
...
không phân biệt chữ hoa chữ thường hoặc xử lý dữ liệu tiếng Việt có dấu vẫn còn hạn chế.


<!-- Trang PDF 81 -->

Ngoài ra, chương trình hiện chủ yếu lưu dữ liệu khi người dùng chọn chức năng lưu và
...
thời gian, chương trình có thể được mở rộng về giao diện, thuật toán, cơ chế lưu trữ dữ
...
viên có thể được tiếp tục phát triển theo nhiều hướng khác nhau để trở nên hoàn thiện
hơn. Các hướng phát triển này tập trung vào việc cải thiện giao diện, tối ưu thuật toán,
nâng cao khả năng lưu trữ dữ liệu, mở rộng chức năng và tăng độ ổn định của chương trình.
...
hợp dữ liệu đã được sắp xếp phù hợp. Về lưu trữ, chương trình có thể chuyển từ file text
sang cơ sở dữ liệu để tăng khả năng quản lý và truy vấn dữ liệu.
...
họa. Giao diện đồ họa sẽ giúp người dùng thao tác trực quan hơn thông qua các nút bấm,
bảng dữ liệu, ô nhập liệu và thông báo lỗi rõ ràng. Điều này đặc biệt hữu ích khi chương
...
Thứ tư, chức năng xử lý điểm và GPA có thể được mở rộng để sát với thực tế hơn.
...
có thể thống kê danh sách sinh viên theo lớp, xếp hạng sinh viên theo GPA, lọc sinh viên
...
phân biệt chữ hoa chữ thường, xử lý tốt hơn dữ liệu tiếng Việt có dấu và cảnh báo chi
tiết hơn khi người dùng nhập sai. Điều này giúp chương trình thân thiện hơn và hạn chế
lỗi dữ liệu trong quá trình sử dụng.
Ngoài ra, nhóm có thể mở rộng phạm vi kiểm thử chương trình. Bên cạnh các file
...
Tài liệu tham khảo
[1] V. T. Nam, Bài giảng Kỹ thuật lập trình - Chương 1: Tổng quan [Slide PowerPoint],
Hà Nội: Đại Học Bách Khoa Hà Nội, 2022.
[2] V. T. Nam, Bài giảng Kỹ thuật lập trình - Chương 2: Cấu trúc dữ liệu và giải thuật
[Slide PowerPoint], Hà Nội: Đại Học Bách Khoa Hà Nội, 2022.
[3] V. T. Nam, Bài giảng Kỹ thuật lập trình - Chương 3: Kỹ thuật thiết kế chương trình
[Slide PowerPoint], Hà Nội: Đại Học Bách Khoa Hà Nội, 2022.
[4] V. T. Nam, Bài giảng Kỹ thuật lập trình - Chương 4: Defensive Programming Lập
trình phòng ngừa [Slide PowerPoint], Hà Nội: Đại Học Bách Khoa Hà Nội, 2022.
[5] V. T. Nam, Bài giảng Kỹ thuật lập trình - Chương 5: Gỡ lỗi và kiểm thử [Slide
PowerPoint], Hà Nội: Đại Học Bách Khoa Hà Nội, 2022.
[6] V. T. Nam, Bài giảng Kỹ thuật lập trình - Chương 6: Tối ưu mã [Slide PowerPoint],
Hà Nội: Đại Học Bách Khoa Hà Nội, 2022.
[7] V. T. Nam, Bài giảng Kỹ thuật lập trình - Chương 7: Lập trình bất đồng bộ
Asynchronous programming [Slide PowerPoint], Hà Nội: Đại Học Bách Khoa Hà Nội,
2022.
...
Phụ lục này trình bày code hàm main của chương trình. Đây là hàm điều khiển luồng
...
B.1.3. Hàm sa_find
Hàm sa_find dùng để tìm sinh viên theo MSSV. Hàm duyệt lần lượt các phần tử
...
B.1.4. Hàm sa_remove
Hàm sa_remove dùng để xóa sinh viên tại vị trí index. Sau khi xóa, các phần tử phía
...
trình. Hai hàm này được cài đặt trong file fileio.c.
B.2.1. Hàm loadAllData
Hàm loadAllData dùng để đọc toàn bộ dữ liệu từ các file text vào bộ nhớ. Hàm lần
lượt gọi các hàm đọc dữ liệu sinh viên, môn học, lớp học phần và điểm số.
...
Trong hàm trên, mỗi loại dữ liệu được đọc từ một file riêng. Dữ liệu sinh viên được
...
Hàm saveAllData giúp quá trình lưu dữ liệu được thực hiện tập trung. Thay vì gọi
...
Hàm convertToHe4 dùng để quy đổi điểm tổng kết hệ 10 sang điểm hệ 4 theo các
...
Hàm calculateStudentGPA10 có cách xử lý tương tự hàm tính GPA hệ 4, nhưng sử
...
Hàm searchStudentByMSSV dùng để tìm sinh viên theo MSSV. Nếu tìm thấy, hàm
...
Hàm sortStudentByName dùng để sắp xếp sinh viên tăng dần theo họ tên. Hàm so
...
file dữ liệu được lưu dưới dạng text, mỗi dòng là một bản ghi và các trường được phân
tách bằng ký tự |.
...
dữ liệu trùng khóa, điểm ngoài khoảng,
file thiếu trường và dữ liệu sai quan hệ
khóa ngoại.
External Testing Nhóm xây dựng các file kiểm thử
như test_types.c, test_arrays.c,
test_fileio_unit.c, test_gpa.c và
test_fileio.c để chương trình có thể
...
White-box Testing Các file kiểm thử tự động gọi trực tiếp
đến các hàm bên trong chương trình
như hàm thao tác mảng động, hàm
đọc/ghi file, hàm tính điểm và hàm tính
GPA. Cách kiểm thử này dựa trên hiểu
biết về cấu trúc và logic bên trong mã
nguồn.
...
qlsv.exe để kiểm thử giao diện, đồng
...
**Hình 8.10: TC11 — Nhập điểm trùng**
**Hình 8.11: TC12 — Cập nhật điểm**


<!-- Trang PDF 102 -->

**Hình 8.12: TC15 — Xếp loại học lực**
**Hình 8.13: TC16 — Tìm sinh viên tồn tại**
**Hình 8.14: TC17 — Tìm sinh viên không tồn tại**
**Hình 8.15: TC21 — Hiển thị bảng điểm lớp học phần**
